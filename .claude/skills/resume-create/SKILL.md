...
特に Step 6（志望動機）では求人の「求める人物像」「業務内容」に沿ったヒントを提示する。
...
- 志望動機（自由記述）
  - 求人コンテキストがある場合：「この会社は〇〇を重視しています（求人の人物像・業務内容より）。それに沿った志望動機にしましょう」とヒントを提示する
- 本人希望（給与・勤務地など。なければ空白）
  - 求人コンテキストがある場合：求人票に明示された勤務地・雇用形態などを提示して確認を促す
